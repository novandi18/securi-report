...
export function SettingsGear(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
...
export function KnowledgeBase(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6.271 2.112C7.11 2 8.166 2 9.556 2h4.888c1.39 0 2.447 0 3.285.112.867.116 1.578.361 2.163.946.586.586.831 1.296.947 2.163.112.838.111 1.894.111 3.285v6.988c0 1.39.001 2.447-.111 3.285-.116.867-.361 1.577-.947 2.163-.585.586-1.296.83-2.163.947-.838.112-1.894.112-3.285.112H9.556c-1.39 0-2.447 0-3.285-.112-.867-.116-1.577-.361-2.163-.947-.585-.586-.83-1.296-.947-2.163C3.05 17.94 3.05 16.884 3.05 15.494V8.506c0-1.39 0-2.447.112-3.285.116-.867.361-1.577.947-2.163.586-.585 1.296-.83 2.163-.946zm-.118 1.492C5.61 3.72 5.19 3.906 4.879 4.217c-.311.311-.497.731-.614 1.274C4.147 6.04 4.05 6.986 4.05 8.5v7c0 1.514.097 2.46.215 3.009.117.543.303.963.614 1.274.311.311.731.497 1.274.614C6.703 20.515 7.649 20.5 9.5 20.5h5c1.851 0 2.797.015 3.347-.103.543-.117.963-.303 1.274-.614.311-.311.497-.731.614-1.274.118-.549.215-1.495.215-3.009v-7c0-1.514-.097-2.46-.215-3.009-.117-.543-.303-.963-.614-1.274-.311-.311-.731-.497-1.274-.614C17.297 3.485 16.351 3.5 14.5 3.5h-5c-1.851 0-2.797-.015-3.347.103zM8 7.25a.75.75 0 000 1.5h8a.75.75 0 000-1.5H8zm0 4a.75.75 0 000 1.5h8a.75.75 0 000-1.5H8zm0 4a.75.75 0 000 1.5h5a.75.75 0 000-1.5H8z"
      />
    </svg>
  );
}
...
export function PanelLeftCloseIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
...
export function PanelLeftOpenIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
...
export function FindingsIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
