...
export const reports = mysqlTable("reports", {
  ...
  // ── Single Finding fields ──
  clientCode: varchar("client_code", { length: 10 }),
  serviceAffected: varchar("service_affected", { length: 50 }),
  findingSequence: int("finding_sequence"),
  issueReferenceNumber: varchar("issue_reference_number", { length: 100 }),
  severity: mysqlEnum("severity", ["Critical", "High", "Medium", "Low", "Info"]).default("Info"),
  location: text("location"),
  description: longtext("description"),
  pocText: longtext("poc_text"),
